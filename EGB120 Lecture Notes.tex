...
\begin{figure}[H]
    \centering
    \includegraphics[height = 8cm, keepaspectratio = true]{filters}
...
\begin{figure}[H]
    \centering
    \includegraphics[height = 4cm, keepaspectratio = true]{passive_low_pass_filter}
...
\begin{figure}[H]
    \centering
    \includegraphics[height = 4cm, keepaspectratio = true]{passive_high_pass_filter}
...
\begin{figure}[H]
    \centering
    \includegraphics[height = 4cm, keepaspectratio = true]{active_low_pass_filter}
...
\begin{figure}[H]
    \centering
    \includegraphics[height = 4cm, keepaspectratio = true]{active_high_pass_filter}
