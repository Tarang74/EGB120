...
\end{figure}
In this circuit, a capacitors can be utilised to smooth ripples.
\begin{definition}[Ripple]
    The ripple in a rectifier can be calculated using the following assumptions:
    \begin{enumerate}
...
\begin{remark}
    ...
    \begin{itemize}
        \item Be careful of power dissipation, particularly when dropping large voltages.
        \item Increasing the series resistance reduces power dissipation but also reduces the regulated current. 
