model half_wave_rectifier
  ...
  Modelica.Electrical.Analog.Basic.Capacitor capacitor1(C = 3 * sqrt(2) / 625) annotation(Placement(visible = true, transformation(origin = {-0, 0}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
