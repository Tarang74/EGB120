model dual_half_wave_rectifier
  ...
  Modelica.Electrical.Analog.Basic.Capacitor capacitor1(C = 3 * sqrt(2) / 2500) annotation(Placement(visible = true, transformation(origin = {0, 15}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Modelica.Electrical.Analog.Basic.Capacitor capacitor2(C = 3 * sqrt(2) / 2500) annotation(Placement(visible = true, transformation(origin = {0, -15}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
